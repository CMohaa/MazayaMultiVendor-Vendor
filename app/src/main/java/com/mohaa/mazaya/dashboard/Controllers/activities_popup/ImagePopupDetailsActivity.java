...
import com.mohaa.mazaya.dashboard.Utils.StringUtils;
import com.mohaa.mazaya.dashboard.Utils.TouchImageView;
...
//    private FloatingActionButton mBtnDownload;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        imgURL = getIntent().getExtras().getString(ProductsUI.BUNDLE_PRODUCTS_IMAGE);
        product_name = getIntent().getExtras().getString(ProductsUI.BUNDLE_PRODUCTS_NAME);
        // ### begin toolbar

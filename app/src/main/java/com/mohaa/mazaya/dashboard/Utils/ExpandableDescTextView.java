...
public class ExpandableDescTextView extends LinearLayout implements View.OnClickListener {

    private static final String TAG = ExpandableDescTextView.class.getSimpleName();
    ...
    public ExpandableDescTextView(Context context) {
        this(context, null);
    }

    public ExpandableDescTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public ExpandableDescTextView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void findViews() {
        mTv = (TextView) findViewById(R.id.productdescription);
        // TODO: 12.05.17 for enabling expand/collapse comment by click on text remove comment
//        mTv.setOnClickListener(this);
        mButton = (TextView) findViewById(R.id.products_details);
        mButton.setText(mCollapsed ? mExpandText : mCollapseText);

package com.mohaa.mazaya.dashboard.Utils.charts;
    ...
    private void drawChart(Canvas canvas) {
        if (items != null) {
            ...
            if (this.mode == MODE_AXIS) {
                ...
                // dessin des axes
                myPaint.setColor(getResources().getColor(R.color.grey_800));
            ...
            if (this.mode == MODE_DRAW_GRID){
                myPaint.setColor(getResources().getColor(R.color.green_300));
                ...
                myPaint.setColor(getResources().getColor(R.color.grey_700));

package com.mohaa.mazaya.dashboard.Utils.searchbar;
...
import com.mohaa.mazaya.dashboard.Utils.searchbar.adapter.DefaultSuggestionsAdapter;
import com.mohaa.mazaya.dashboard.Utils.searchbar.adapter.SuggestionsAdapter;
...
public class MaterialSearchBar extends RelativeLayout implements View.OnClickListener,
    ...
    public void setNavButtonEnabled(boolean navButtonEnabled) {
        ...
        if (navButtonEnabled) {
            //navIcon.setVisibility(VISIBLE);//TODO
           ...
           // navIcon.setVisibility(INVISIBLE);//TODO
    ...
    public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
        if (listenerExists())
            onSearchActionListener.onSearchConfirmed(searchEdit.getText().toString());
        if (suggestionsVisible)
            hideSuggestionsList();
        if (adapter instanceof DefaultSuggestionsAdapter)
